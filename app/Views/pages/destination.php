                    ...
                    <div class="elementor-widget-container">
                        <div class="justify-content-center">
                            <div class="section-title1">
                                ...
                                <h3 class="title-section" style="margin-bottom: 15px !important;color:black;">
                    ...
                    <div class="best-plan-single1 d-flex flex-column h-100">
                        ...
                        <div class="content h-100 d-flex flex-column" style="justify-content: space-between;">
                            <div>
                                ...
                                <h4>
                                    <a style="font-family: 'Open Sans' !important;font-weight: 700 !important;font-size: 30px; line-height: 42px;" href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>/<?= $destination['slug'] ?>">
                                        <?= $destination['title'] ?>
                                    </a>
                                </h4>
                                <div class="best-plan-meta">
                                    <span class="duration" style="font-family: 'Open Sans' !important;font-weight: 500;font-size: 18px; line-height: 24px;"><i class="bi bi-clock"></i>

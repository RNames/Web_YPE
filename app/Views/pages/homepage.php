                                        ...
                                        <div class="elementor-widget-wrap elementor-element-populated" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                                            ...
                                            <div class="elementor-element elementor-element-15c7e1e elementor-widget elementor-widget-astrip_button" data-id="15c7e1e" data-element_type="widget" data-widget_type="astrip_button.default">
                                                <div class="elementor-widget-container" style="display: flex; justify-content: center;">
                                                    <a aria-hidden="true" href="https://www.instagram.com/yourprivateeurope?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" class="eg-btn btn--primary-outline btn--lg" style="background-color: #e0bc6d; font-family: 'Oswald';" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">
                                                        Follow on Instagram
                                                    </a>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="elementor-widget-container">
                                                                <div class="row justify-content-center">
                                                                    <div class="btn-align d-flex justify-content-center">
                                                                        <a aria-hidden="true" href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>/<?= $destination['slug'] ?>" class="eg-btn btn--primary-outline btn--lg" style="background-color: #e0bc6d; font-family: 'Oswald'; padding: 10px 35px;" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-6 col-button" style="color: white; margin-top: 50px; margin-bottom: 50px;">
                <a aria-hidden="true" href="/<?= $language ?>/hubungi-kami" class="eg-btn btn--primary btn--lg" style="background-color: #e0bc6d; font-family: 'Oswald';" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">

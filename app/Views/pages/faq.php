                                    ...
                                    <div class="elementor-widget-container">
                                        ...
                                        <div class=" justify-content-center">
                                            <div class="section-title1">
                                                <span style="color:#086B7D !important;font-weight: 700;letter-spacing: 0px !important;font-size: 16px;line-height: 27px;font-family: 'Open Sans' !important;">
                                                    <?= $language == 'id' ? $faqs[0]['faq_section_id'] : $faqs[0]['faq_section_en'] ?>
                                                </span>
                                                <h2 style="color: black; font-weight: bold;margin-bottom: 15px !important;font-size: 30px;line-height: 42px;font-family: 'Open Sans' !important;">

                            ...
                            <article aria-label="article" id="post-2537" class="post-2537 post type-post status-publish format-standard has-post-thumbnail hentry category-adventure category-couple-tour tag-hotel tag-tours tag-travel tag-vacation">
                                <div>
                                    ...
                                    <div class="blog-content">
                                        <h3>
                                            <a style="font-family: 'Open Sans' !important;font-weight: 700;font-size: 30px;line-height: 42px;" href="/<?= $language ?>/blog/<?= $article['slug'] . '/' . $article['id'] ?>">
                                                <?= $language == 'id' ? $article['title_id'] : $article['title_en'] ?>
                                            </a>
                                        </h3>
                                        <div class="author-area">
                                            <p  style="font-family: 'Open Sans' !important;font-weight: 500;font-size: 18px;line-height: 24px;"><?= lang('text_article.by') ?> <a href="#"><?= $article['writer'] ?></p>
                                        </div>
                                        ...
                                        <a href="/<?= $language ?>/blog/<?= $article['slug'] . '/' . $article['id']  ?>" class="eg-btn btn--primary btn--lg" style="background-color: #e0bc6d; font-family: 'Open Sans';font-weight: 600!important;" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'"><?= lang('text_article.continue_reading') ?></a>
                                        </div>
                                        <!--<div class="blog-meta">-->
                                        <!--    <a style="font-family: 'Open Sans' !important;font-weight: 500;font-size: 18px;line-height: 24px;" href="/<?= $language ?>/blog/<?= $article['slug'] . '/' . $article['id']  ?>" class="read-more-btn"><?= lang('text_article.continue_reading') ?><i class="bi bi-arrow-right"></i></a>-->
                        ...
                        <div class="wp-block-group is-layout-flow wp-block-group-is-layout-flow">
                            <div class="wp-block-group__inner-container">
                                ...
                                <ul class="wp-block-latest-posts__list has-dates wp-block-latest-posts">
                                    ...
                                    <li>
                                        <a class="wp-block-latest-posts__post-title" style="font-family: 'Open Sans' !important;font-weight: 500;font-size: 18px;line-height: 24px;" href="/<?= $language ?>/<?= $language == 'id' ? 'layanan-kami' : 'our-services' ?>/<?= $service['slug'] ?>">
                                            <?= $service['title_en'] ?>
                                        </a>
                                    </li>
                                    <?php endforeach; ?>
                                ...
                                <ul class="wp-block-latest-posts__list has-dates wp-block-latest-posts">
                                    ...
                                    <?php foreach ($latestArticle as $article) : ?>
                                        <li>
                                            ...
                                            <time datetime="2023-02-18T09:42:49+00:00" class="wp-block-latest-posts__post-date"style="font-family: 'Open Sans' !important;">
                                                <?= $article['date']  ?>
                                            </time>
                                        </li>
                                    <?php endforeach; ?>
